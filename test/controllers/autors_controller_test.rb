...
class AutorsControllerTest < ActionController::TestCase
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post :create, autor: { first_name: @autor.first_name, name: @autor.name, nationality: @autor.nationality }
    end
  ...
  test "should update autor" do
    patch :update, id: @autor, autor: { first_name: @autor.first_name, name: @autor.name, nationality: @autor.nationality }
    assert_redirected_to autor_path(assigns(:autor))
  end
